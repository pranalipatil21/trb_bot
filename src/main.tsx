...
const App = () => {
  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    try {
      const systemInstruction = activeTab === 'support'
        ? "You are the Team Red Baron Post-Sales AI Assistant. Provide maintenance, troubleshooting, and warranty advice for custom ATVs. Be technical, helpful, and precise."
        : "You are the Team Red Baron Risk Analyst. Analyze market trends, supply chain logistics, and environmental regulations for motorsports. Predict risks and suggest mitigation strategies.";
  ...
  const handleContact = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const subject = `Inquiry from ${name} via Team Red Baron Website`;
    ...
    <div className="relative min-h-screen selection:bg-rose-500 selection:text-white">
      ...
      <nav className="fixed top-0 w-full z-50 glass-nav py-4 px-8 flex justify-between items-center">
        <div className="flex items-center gap-3">
          ...
          <span className="brand-font text-xl font-black tracking-widest text-white">TEAM RED BARON</span>
        </div>
      ...
      <section id="home" className="relative h-screen flex flex-col justify-center items-center text-center px-4 hero-gradient">
        <h1 className="text-6xl md:text-8xl font-black mb-4 animate-pulse">TEAM RED BARON</h1>
      ...
      <footer className="py-12 border-t border-white/10 text-center text-slate-500">
        ...
        <p className="text-xs uppercase tracking-widest font-bold">©2025 TEAM RED BARON | DETERMINED TO WIN</p>
      </footer>
