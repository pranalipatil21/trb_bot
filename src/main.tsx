  ...
  const handleSendMessage = async (e: React.FormEvent) => {
    ...
    try {
      const systemInstruction = activeTab === 'support'
        ? "You are the Red Baron motorcorp Post-Sales AI Assistant. Provide maintenance, troubleshooting, and warranty advice for custom ATVs. Be technical, helpful, and precise."
        : "You are the Red Baron motorcorp Risk Analyst. Analyze market trends, supply chain logistics, and environmental regulations for motorsports. Predict risks and suggest mitigation strategies.";
